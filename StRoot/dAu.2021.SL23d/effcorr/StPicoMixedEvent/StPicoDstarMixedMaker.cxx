...
void StPicoDstarMixedMaker::initHists()
{
  ...
  hMeeCountPtCen = new TH3F("hMeePtTPCTrks","hMee vs p_{T} vs Cen;Mee(GeV/c^{2});p_{T};Cen",800,0,4,200,0,10,16,0,16);
  hMeeCountPtCen_like1 = new TH3F("hMeePtTPCTrks_like1","hMee vs p_{T} vs Cen like sign electron;Mee(GeV/c^{2});p_{T};Cen",800,0,4,200,0,10,16,0,16);
  hMeeCountPtCen_like2 = new TH3F("hMeePtTPCTrks_like2","hMee vs p_{T} vs Cen like sign positron;Mee(GeV/c^{2});p_{T};Cen",800,0,4,200,0,10,16,0,16);

  hMeeMixPtCen = new TH3F("hMeeMix_Pt_Cen","hMeeMix vs p_{T} vs Cen;Mee(GeV/c^{2});p_{T};Cen",800,0,4,200,0,10,16,0,16);
  hMeeMixPtCen_like1 = new TH3F("hMeeMixlike1_Pt_Cen","hMeeMix vs p_{T} vs Cen like sign electron;Mee(GeV/c^{2});p_{T};Cen",800,0,4,200,0,10,16,0,16);
  hMeeMixPtCen_like2 = new TH3F("hMeeMixlike2_Pt_Cen","hMeeMix vs p_{T} vs Cen like sign positron;Mee(GeV/c^{2});p_{T};Cen",800,0,4,200,0,10,16,0,16);
